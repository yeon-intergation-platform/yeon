  ...
  if (mode === "create" && seedState.kind === "loading") {
    return (
      <div className="flex min-h-screen items-center justify-center bg-white text-[#111]">
        <div className="flex flex-col items-center gap-3 text-center font-mono text-[13px] text-[#888]">
        ...
        <div className="max-w-md rounded-3xl border border-[#e5e5e5] bg-white p-8 text-center shadow-sm">
          ...
          <div className="mt-6 grid gap-2 sm:grid-cols-2">
            <button
              ...
              className="rounded-2xl bg-[#111] px-5 py-3 text-[14px] font-bold text-white"
            >
              다시 시도
            </button>
            <button
              ...
              className="rounded-2xl border border-[#e5e5e5] px-5 py-3 text-[14px] font-bold text-[#555]"
            >
              기본 덱으로 시작
            </button>
          </div>
          <Link
            ...
            className="mt-4 inline-flex text-[13px] font-semibold text-[#888] no-underline hover:text-[#111]"
          >
            로비로 돌아가기
          </Link>
        </div>
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#f7f7f5] px-6 text-[#111]">
        <div className="max-w-md rounded-3xl border border-[#e5e5e5] bg-white p-8 text-center shadow-sm">
          ...
          <Link
            href="/typing-service/rooms"
            className="mt-6 inline-flex rounded-2xl bg-[#111] px-5 py-3 text-[14px] font-bold text-white no-underline"
          >
            로비로 돌아가기
          </Link>
        </div>
        ...
        <section className="rounded-3xl border border-[#e5e5e5] bg-white p-6 shadow-sm md:p-8">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <div className="flex flex-wrap items-center gap-2">
                <span className="rounded-full bg-[#111] px-2.5 py-1 text-[11px] font-bold text-white">
                  대기중
                </span>
                <span className="font-mono text-[12px] text-[#aaa]">
                  #{room.roomCode}
                </span>
                <span className="rounded-full bg-[#f4f4f0] px-2.5 py-1 text-[11px] font-bold text-[#555]">
          ...
          <div className="mt-8 grid gap-3">
            ...
            {room.participants.map((participant) => (
              <div
                key={participant.id}
                className="flex items-center justify-between rounded-2xl border border-[#ececec] bg-[#fafafa] px-4 py-3"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-[15px] font-black shadow-sm">
                    {participant.role === "host" ? (
                      <Crown size={18} className="text-[#ff9f1c]" />
                    ) : (
                ...
                <span
                  className={`rounded-full px-3 py-1 text-[12px] font-bold ${participant.isReady ? "bg-[#e9f8df] text-[#3f7f1d]" : "bg-[#f1f1f1] text-[#888]"}`}
                >
