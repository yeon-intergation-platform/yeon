export const TYPING_PROFILE_CARD_CLASS = {
  ...
  spriteWrapper:
    "mb-5 flex h-[300px] w-full items-end justify-center rounded-xl bg-[#fafafa] px-3 py-3 sm:mb-6 sm:h-[360px] sm:px-4",
  skeletonSpriteWrapper:
    "mb-5 flex h-[300px] w-full items-center justify-center rounded-xl bg-[#fafafa] px-3 py-3 sm:mb-6 sm:h-[360px] sm:px-4",
  skeletonText: "text-[13px] font-medium text-[#aaa]",
  skeletonNickname:
    "mb-5 h-[28px] w-28 rounded-full bg-[#fafafa] text-transparent",
  skeletonButtonRow: "flex flex-wrap justify-center gap-2",
  skeletonButton: "h-[44px] w-16 rounded-lg bg-[#fafafa]",
  ...
  nicknameButton:
    "flex min-h-[44px] items-center gap-1.5 px-2 text-[20px] font-semibold text-[#111] hover:text-[#666]",
  nicknameEditIcon: "text-[14px] font-normal text-[#aaa]",
