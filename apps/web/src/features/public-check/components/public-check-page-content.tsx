...
} from "../hooks/use-public-check";

type PublicCheckPageContentProps = {
  token: string | null;
...
export function PublicCheckPageContent({
  token,
  entryMode,
}: PublicCheckPageContentProps) {
  ...
  }, [token, entryMode, session?.requiresPhoneLast4, session?.checkMode]);
