      ...
      {open ? (
        ...
        >
          <section
            ...
            className="max-h-[min(720px,calc(100vh-32px))] w-[min(100%,720px)] overflow-y-auto rounded-[28px] border border-[#e5e5e5] bg-white p-6 text-[#111] shadow-[0_28px_80px_rgba(17,17,17,0.18)] sm:p-8"
