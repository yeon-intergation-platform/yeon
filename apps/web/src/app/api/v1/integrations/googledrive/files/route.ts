...
import { GoogleDriveBrowserSpringBackendHttpError, fetchGoogleDriveFilesFromSpring } from "@/server/googledrive-browser-spring-client";
...
export async function GET(request: NextRequest) {
  ...
  try {
    const payload = await fetchGoogleDriveFilesFromSpring({
