import { useYeonMutation as useMutation, showYeonAlert } from "@yeon/ui/native";
...
export function useCardOnboardingGateState({
  onAuthenticated,
}: UseCardOnboardingGateStateParams) {
  ...
  return {
    ...
    handleSocialLogin,
    isBusy,
    isEmailLoginPending: loginMutation.isPending,
    isEmailSheetOpen,
    password,
    setEmail,
    setEmailSheetOpen,
