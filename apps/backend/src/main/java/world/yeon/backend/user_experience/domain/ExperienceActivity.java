...
public enum ExperienceActivity {
   ...
   * 이 집합으로 제한한다. 현재는 타자 레이스 완료와 게임 플레이를 내부 호출로 적립한다.
   */
  private static final Set<ExperienceActivity> INTERNAL_AWARDABLE =
      Set.of(TYPING_RACE_FINISHED, GAME_PLAY);
