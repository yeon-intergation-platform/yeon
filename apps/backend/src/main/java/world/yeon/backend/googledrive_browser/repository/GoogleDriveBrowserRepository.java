package world.yeon.backend.googledrive_browser.repository;
...
@Repository
public class GoogleDriveBrowserRepository {
	...
	public GoogleDriveBrowserRepository(EntityManager entityManager, OAuthTokenSecretProtector secretProtector) {
