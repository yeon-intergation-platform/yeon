...
name: domain-routing
description: |-
  Yeon 서비스 URL, Cloudflare Tunnel/Public Hostname, Access, DNS, subdomain, redirect, CORS, 쿠키, WebSocket, canonical/sitemap, 운영 도메인 라우팅 작업 또는 질문에 사용한다.
---
...
1. `Read(".claude/commands/domain-routing.md")` 을 즉시 호출하여 전체 내용을 받는다.
