...
description: |-
  인증/credential 작업에서 팀원이 기능/디자인/경계 컨텍스트를 빠르게 로드하기 위한 서비스별 킥오프 스킬. 로그인, 회원가입, 이메일 인증, 비밀번호 재설정, social auth/session 작업에 사용한다.
---
...
1. `Read(".claude/skills/service-context-auth-credential.md")` 을 즉시 호출하여 전체 내용을 받는다.
