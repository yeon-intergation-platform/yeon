...
description: |-
  공모전/contest 제출 자료와 contest contract 작업에서 팀원이 기능/디자인/경계 컨텍스트를 빠르게 로드하기 위한 서비스별 킥오프 스킬. contest docs, submission copy, contest API contract 작업에 사용한다.
---
...
1. `Read(".claude/skills/service-context-contest.md")` 을 즉시 호출하여 전체 내용을 받는다.
