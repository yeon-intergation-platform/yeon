...
globs:
  ...
  - apps/web/src/features/counseling-service-shell/**
  - apps/web/src/features/student-management/**
  - apps/web/src/components/student-management-ui/**
---
# Counseling Workspace (Claude wrapper)

이 파일은 wrapper다. 실제 규칙은 SSOT에 있다.

**SSOT**: `docs/agent-rules/counseling-workspace.md`
