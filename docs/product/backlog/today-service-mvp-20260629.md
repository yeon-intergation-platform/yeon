...
> 완료된 브라우저 MVP의 역사 문서다. 2026-07-22 이후 장기 저장·라우트·개편 구현은 [`2026-07-22-yeon-today-server-redesign.md`](./2026-07-22-yeon-today-server-redesign.md)의 Spring 단일 원본 결정을 우선한다.
