...
범위: typing, card, community, account 공용 support 글과 mooddesk 제외 정책
...
8. mooddesk는 공개 support 글을 만들지 않는 정책을 테스트로 고정한다.
...
3. mooddesk는 support 공개 글 대상에서 제외하는 정책을 테스트로 고정했다.
4. 공개 콘텐츠 500단계 계획의 326~350 항목을 완료로 표시했다.
